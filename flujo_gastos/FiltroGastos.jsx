...
const FiltroGastos = ({ onDataFiltered, correoUsuario, mapaAreaLideres, empleadosAdicionales = [] }) => {
    ...
    try {
      ...
      if (areaLider) {
        data = data.filter((gasto) =>
          gasto.area === areaLider ||
          empleadosAdicionales.includes(gasto.correo_empleado)
        );
      }
